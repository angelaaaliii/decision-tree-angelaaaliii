...
public class Row {
     ...
     *
     * From the "attributeValues" hashmap, get all keys (equivalent to column names
     ...
     * class represents a SINGLE row, to look up one specific value for the
     ...
     * access calls. Used to determine the order on which
     ...
     * in the attributeAccesses list because in Node class,
